...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-slate-800 data-[state=open]:bg-slate-800",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-32 overflow-hidden rounded-md border border-slate-700",
      "bg-[#1E293B] p-1 text-white shadow-lg",
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-48 overflow-hidden rounded-md border border-slate-700",
        "bg-[#1E293B] p-1 text-white shadow-xl",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        className
      )}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      className={cn(
        "ml-auto text-xs tracking-widest text-[#A1A7B3]",
        className
      )}
      {...props}
    />
